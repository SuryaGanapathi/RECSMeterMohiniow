...
public class SharedPreferenceUtil {
    ...
    public static String setAreaCode(Context context, String SupplierId) {
    ...
    public static int setBillNumber(Context context, int SupplierId) {

        try {
            saveInPreference(context, "bill", SupplierId);
        } catch (Exception e) {
            PrintLog.print(TAG, e.getMessage());
            e.printStackTrace();
        }
    ...
    public static int getBillNo(Context context) {
        try {
            return (int) getFromPreference(context, "bill", 100000);
        } catch (Exception e) {
            PrintLog.print(TAG, e.getMessage());
            e.printStackTrace();
            return 1;
    ...
    public static String setBurntMeterCharge(Context context, String session_start_time) {

        try {
            saveInPreference(context, "BURNT_CHARGE", session_start_time);
        } catch (Exception e) {
            PrintLog.print(TAG, e.getMessage());
            e.printStackTrace();
        }
    ...
    public static String getBurntMeterCharge(Context context) {
        try {
            return getFromPreference(context, "BURNT_CHARGE", "");
        } catch (Exception e) {
            PrintLog.print(TAG, e.getMessage());
            e.printStackTrace();
            return "0";
