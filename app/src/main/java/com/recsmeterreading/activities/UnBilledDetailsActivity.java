...
public class UnBilledDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_un_billed_details);
        ...
        ToImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(UnBilledDetailsActivity.this, "select ist date ist", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                if (display == FromDisplay) {
                    ...
                    if (dayOfMonth >=cur_date) {
                        ...
                        Toast.makeText(UnBilledDetailsActivity.this, "To date should be greater than from date.", Toast.LENGTH_SHORT).show();
                    }
                }
